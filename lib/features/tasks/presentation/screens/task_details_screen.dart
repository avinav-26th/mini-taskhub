                  ...
                  children: [
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                const Icon(Icons.calendar_today, size: 25, color: Colors.grey),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [BoxShadow(color: themeColor.withValues(alpha: 0.3), blurRadius: 10, offset: const Offset(0, 5))],
                      ),
                      child: Column(
                        children: [
                          Row(
                          ...
                          Row(
                            ...
                            children: [
                              IconButton(
                                icon: Icon(timerState.isRunning ? Icons.pause : Icons.play_arrow_rounded, color: Colors.white, size: 38),
